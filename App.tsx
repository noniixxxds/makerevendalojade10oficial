...
export default function App() {
  return (
    <div className="min-h-screen bg-brand-bg font-sans text-gray-800 pb-24 md:pb-0 selection:bg-brand-pink selection:text-white overflow-x-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 flex flex-col items-center">
          ...
          <div className="bg-white p-6 md:p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.4)] max-w-lg w-full animate-bounce-in border-4 border-white">
             <div className="flex flex-col items-center">
                ...
                {/* GIF INSIDE THE CARD - ORIGINAL SIZE (PROPORTIONAL) */}
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-200">
         <div className="container mx-auto px-4 max-w-6xl">
           ...
           <div className="text-center mb-16">
              ...
              <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Estoque limitado para novos revendedores</p>
           </div>
      ...
      <section className="py-24 bg-brand-dark text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
           ...
           <p className="text-xl md:text-2xl text-pink-100 mb-12 leading-relaxed font-medium">
             Pare de adiar seu sonho. Fale com nossas consultoras e escolha o kit certo para você lucrar muito.
           </p>

           <a href={SUPPORT_LINK} className="inline-flex items-center gap-4 bg-[#25D366] hover:bg-green-600 text-white font-black py-8 px-16 rounded-full shadow-[0_20px_50px_rgba(37,211,102,0.5)] text-3xl md:text-4xl transition-all transform hover:scale-105 border-b-8 border-green-800">
      ...
      <footer className="bg-[#0f0005] text-white py-16 text-center">
         <div className="container mx-auto px-4">
